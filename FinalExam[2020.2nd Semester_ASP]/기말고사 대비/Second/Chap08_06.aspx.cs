...
{
    public partial class Chap08_06 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Cmd.Connection = Con;
            if (DropDownList1.SelectedValue == "정렬 안함")
                Cmd.CommandText = "select* from StudentInfoTable01";
            else
                Cmd.CommandText = "select * from StudentInfoTable01 order by grade " + DropDownList1.SelectedValue;
