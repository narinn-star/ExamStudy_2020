...
{
    public partial class Chap08_07 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (DropDownList2.SelectedValue == "정렬 안함")
                Cmd.CommandText = "select * from StudentInfoTable01 where grade" + DropDownList1.SelectedValue + grade;
            else
                Cmd.CommandText = "select * from StudentInfoTable01 where grade" + DropDownList1.SelectedValue  + grade + "order by grade " + DropDownList2.SelectedValue;
