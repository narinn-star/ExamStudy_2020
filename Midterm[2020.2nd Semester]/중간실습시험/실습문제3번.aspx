<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="실습문제3번.aspx.cs" Inherits="Midterm_2020._2nd_Semester_.중간실습시험.실습문제3번" %>
    ...
    <table class="auto-style10">
        <tr>
            <td class="auto-style11">
                <asp:TextBox ID="TextBox4" runat="server" CssClass="auto-style16">0</asp:TextBox>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p>
        ...
        <asp:TextBox ID="TextBox3" runat="server" CssClass="auto-style15">0</asp:TextBox>
    </p>
</asp:Content>
