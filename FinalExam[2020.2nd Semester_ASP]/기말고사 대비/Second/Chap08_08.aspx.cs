...
{
    public partial class Chap08_08 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Cmd.Connection = Con;
            Cmd.CommandText = "select * from StudentInfoTable01 where sex='" 
                + DropDownList1.SelectedValue + "' " + DropDownList2.SelectedValue + " grade =" + DropDownList3.SelectedValue;
