...
{
    public partial class Chap08_09 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Cmd.Connection = Con;
                Cmd.CommandText = "select name, id from StudentInfoTable01";
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand Cmd = new SqlCommand();
            Cmd.Connection = Con;
            Cmd.CommandText = "select * from StudentInfoTable01 where id= '" + DropDownList1.SelectedValue + "'";
