...
namespace _2020._07._04_07
{
    public partial class Form1 : Form
    {
        ...
        private void 끝내기ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("끝내기를 하는 도중 에러가 발생하였습니다.", "에러", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show("종료를 하는 도중 에러가 발생하였습니다.", "에러", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
    }
}
